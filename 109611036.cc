...
main(int argc, char* argv[])
{
    ...
    //Check Seed
    //uint32_t defaultSeed = SeedManager::GetSeed();
    ...
    //Create three nodes
    nodes.Create(3);
    //Flow1: DataRate:2Mbps, Delay 2ms
    ...
    //Flow2: DataRate:3Mbps, Delay 2ms
    ...
    //Create Interface1 and Interface2 in node0
    ...
    //one client and two servers, with each two flows sending 4 UPD packets
